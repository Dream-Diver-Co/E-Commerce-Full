...
class WinterController extends Controller
{
    ...
    {
        $winters = Winter::all();
        return view('admin.pages.winter_offer.index')->with('winters', $winters);
    }

    public function create()
    {
        return view('admin.pages.winter_offer.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.pages.winter_offer.show')->with('winters', $winter);
    }

    public function edit($id)
    {
        $winter = Winter::find($id);
        return view('admin.pages.winter_offer.edit')->with('winters', $winter);
    }
