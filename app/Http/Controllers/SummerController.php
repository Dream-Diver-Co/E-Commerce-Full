...
class SummerController extends Controller
{
    ...
    {
        $summers = Summer::all();
        return view('admin.pages.summer_offer.index')->with('summers', $summers);
    }

    public function create()
    {
        return view('admin.pages.summer_offer.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.pages.summer_offer.show')->with('summer', $summer);
    }

    public function edit($id)
    {
        $summer = Summer::find($id);
        return view('admin.pages.summer_offer.edit')->with('summer', $summer);
    }
