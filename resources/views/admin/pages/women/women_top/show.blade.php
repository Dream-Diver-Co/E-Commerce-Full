...
<!-- end page title -->
                ...
                <div class="card">
                    <div class="card-header">womentop Details</div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('womentop.destroy', $womentop->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this womentop?')">Delete</button>
                        </form>
                        <a href="{{ route('womentop.index') }}" class="btn btn-secondary">Back</a>
                    </div>
                </div>
@endsection
